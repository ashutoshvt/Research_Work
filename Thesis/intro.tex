...
experimental measurements. While a quantum mechanical treatment of both the solute and solvent molecules would be ideal, 
...
solvent in the form of a classical potential by replacing them with point charges, polarizabilities, etc.,\cite{Lin06,Warshel72,Warshel76}
...
charge model (FQ)\cite{Rick94}, the drude oscillator model\cite{Lamoureux03} and the effective fragmentation potential (EFP)\cite{JensenGordon96} are few examples in this context.\\
...
due to the failure of the PCM model in capturing the dominant nonelectrostatic solute-solvent interactions 
...
in cyclohexane at 355 nm, even after incorporating accurate electron correlation theories\cite{Koch97,Kongsted05}. Similar trends were observed 
when Caricato combined PCM with CC response theory to calculate specific rotations of solvated molecules\cite{Caricato13}.\\
...
calculation. Furthermore, it failed to reproduce the correct sign of the specific rotations for some of 
...
applying conformationl averaging to ``flexible" molecules, zero-point vibrational corrections, accounting for temperature effects, etc.\cite{Crawford06}
...
techniques like the pair natural orbitals (PNO) approach\cite{NeeseCCSD09,Neese09} which has been really successful in describing the energetics of 
