...
The necessary equations required to calculate dynamic polarizabilities and specific rotations within the CC linear response formalism are derived in Chapter 2. %Also, a brief description of solvation models that have been used for modeling chiroptical properties 
%is provided. 
